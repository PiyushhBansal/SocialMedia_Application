...
const fetchStories = async () => {
  try {
    ...
    dispatch(setAllStories(Object.values(grouped))); // <-- SEND GROUPED DATA
    ...
    <>
      <div className="flex w-full overflow-x-auto gap-4 px-6 py-4 border-b border-neutral-200">
        ...
        <div
          ...
          onClick={() => {
                if (myStoryGroup) handleStoryClick(myStoryGroup);
          ...
          .map((storyGroup) => (
            ...
            >
              <div className="w-[60px] h-[60px] rounded-full bg-gradient-to-br from-purple-500 to-pink-500 p-[2px]">
                <img
                  src={
                    storyGroup.author.profilePicture || "/default-avatar.png"
                  }
